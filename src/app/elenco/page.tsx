...
export default async function ElencoPage({ searchParams }: ElencoPageProps) {
      ...
      <section className="bg-black py-20 text-white">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-end lg:px-8">
          ...
          <div className="grid gap-3 sm:grid-cols-4">
            ...
            />
            <StatCard dark label="Ativos" value={activeCount} detail="elenco atual" />
            <StatCard
              dark
              label="Ex-jogadores"
              value={formerCount}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {statusOptions.map((option) => (
                <FilterChip
                  key={option.value}
                  href={makeFilterHref("/elenco", resolvedSearchParams, {
                    status: option.value,
                  })}
                  active={
